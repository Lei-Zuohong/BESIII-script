...
#                            For python                  #
#                                                        #
#         September 2019, Zuo.Hong Lei                   #
#         leizuoho@mail.ustc.edu.cn                      #
#                                                        #
##########################################################
...
#       FormatAxis(axis)                                #
#       FormatData(datahist)                            #
#       NameAxes(datahist, xname, yname)                #
#       FormatMC1(mc1hist)                              #
#       FormatMC2_hist(mc2hist)                         #
#       FormatMC2_graph(mc2hist)                        #
#       FormatMC3(mc3hist)                              #
#       WriteBes3()                                     #
#       WritePreliminary()                              #
#       MakeLegend_hist()                               #
...
def NameAxes(datahist, xname, yname):
    ...
    datahist.GetYaxis().SetTitle(xname)
